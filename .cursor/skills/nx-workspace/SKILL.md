...
Prefer the workspace package manager instead of relying on a global Nx install. Check `package.json` and the lockfile to determine which command to use. In this repo, prefer `npm exec -- nx ...`.
