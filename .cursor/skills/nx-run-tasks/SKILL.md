...
Prefer the workspace package manager instead of relying on a global Nx install. Look at the package.json or lockfile to determine which package manager is in use. In this repo, prefer `npm exec -- nx ...`.
