...
| --- | ---------------------- | ------------------------------------------------------------------------------------------------------------ |
| 1   | Visual hierarchy       | Is the primary action obvious on Home, Search, Library, and the playback sheet?                              |
...
| 9   | Empty states           | Do empty Search, Library, playlists, and saved loops guide the user toward the next action?                  |
