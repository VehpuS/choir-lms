...
- [ ] 5.3a Make standalone track and loop playback expose current-item repeat controls without requiring an active queued playback session, and validate repeat-one behavior for single-item playback.
