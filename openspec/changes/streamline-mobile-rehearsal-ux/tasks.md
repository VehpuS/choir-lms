...
- [ ] 6.2.2 Manually verify queue-to-playlist capture from Now Playing: use `Create new playlist` and `Update playlist`, confirm resulting playlist item order, and confirm current playback item and position remain uninterrupted.
