...
- [ ] 2.7.8 Move playback status messaging out of layout-shifting Library content cards and into standard non-disruptive surfaces. Route paused, ready, preparing/loading, and success feedback through the mini-player, snackbar/toast-style feedback, or a notification/status menu as appropriate; reserve prominent inline cards for blocked or error states that require user action; and ensure transient playback status never pushes Library browsing content down or changes row positions during normal playback transitions.
