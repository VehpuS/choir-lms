...
- [ ] 2.7.3 Reduce playlist-detail label and empty-state noise: demote or remove the `Playlist detail` eyebrow where the playlist title and back button already provide context, shorten empty-playlist copy, and align it with the folder-aware add-items work from task `2.5.10`.
