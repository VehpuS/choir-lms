...
- [ ] 2.7.10 Add musician-friendly loop creation shortcuts after the baseline loop builder is stable: set start or end from current playback position, nudge start/end boundaries, and expose quick range-adjustment controls without making the default builder visually heavier.
