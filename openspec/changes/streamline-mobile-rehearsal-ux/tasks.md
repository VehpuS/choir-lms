...
- [ ] 2.7.5 Tighten Files explorer chrome hierarchy by reducing duplicate current-folder naming between the navigation title and breadcrumb bar, for example by making breadcrumbs smaller or omitting the disabled final breadcrumb segment while preserving parent-folder jump targets.
