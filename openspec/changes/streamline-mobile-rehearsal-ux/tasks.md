...
- [ ] 2.7.4 Make Add Drive browse metadata quieter by hiding exact `Updated` dates in default browsing unless the user is searching, sorting by date, or inspecting item details; keep item type, saved/playable state, shared-folder status, preview, and save affordances more prominent than file-system timestamps.
