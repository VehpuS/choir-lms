          ...
          >
            <View style={styles.shadowBox}>
              ...
              <View style={styles.codeBlock}>
                ...
                >
                  nx build MobileRehearsalPlayer
                </Text>
                <Text style={[styles.textXS, styles.monospace, styles.comment]}>
                  # Test
                </Text>
                ...
                >
                  nx test MobileRehearsalPlayer
                </Text>
                <Text style={[styles.textXS, styles.monospace, styles.comment]}>
                  # Lint
                </Text>
                <Text style={[styles.textXS, styles.monospace]}>
                  nx lint MobileRehearsalPlayer
                </Text>
                <Text style={[styles.textXS, styles.monospace, styles.comment]}>
                  # Run them together!
                </Text>
                ...
                >
                  nx run-many -p MobileRehearsalPlayer -t build test lint
                </Text>
              </View>
              ...
              <View style={[styles.codeBlock, styles.marginBottomLg]}>
                <Text style={[styles.textXS, styles.monospace]}>
                  nx show project MobileRehearsalPlayer
                </Text>
              </View>
              <View style={styles.listItem}>
                <Svg
